	...
	<div class="container">
		<form class="signup-form row justify-content-md-center" method="post" action="signup.php">
			...
			<div class="mb-3 col-12 col-md-4">
				...
				<input type="text" class="form-control" name="login" value="<?= $user ?>" id="formGroupExampleInput"
					placeholder="Логин" />
			</div>
			<div class="w-100"></div>
			<div class="mb-3 col-12 col-md-4">
				<label for="exampleInputEmail1" class="form-label">Email address</label>
				<input type="email" class="form-control" name="email" value="<?= $email ?>" id="exampleInputEmail1"
